...
def PCA_and_augment(data_in):
    ...
    datas_mean_remov = np.transpose(datas_mean_remov)
...
def multi_stage_saak_trans(components_pca):
    ...
    for i in range(num):
        ...
        train_data, train_filt, train_output = one_stage_saak_trans(train_data, depth=i, components_pca=components_pca[i])
